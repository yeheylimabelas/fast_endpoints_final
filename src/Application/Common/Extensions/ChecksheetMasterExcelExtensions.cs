// -----------------------------------------------------------------------------------
// ChecksheetMasterExcelExtensions.cs 2024
...
/// Excel Extension
/// </summary>
public static class ChecksheetMasterExcelExtensions
{
    /// <summary>
    /// Read Xlsx
    /// </summary>
    ...
    /// <returns></returns>
    public static async Task<DataTable> FromXlsxChecksheetMaster(this IFormFile file, CancellationToken cancellationToken)
    {
